...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        '/': (context) =>
            const MyHomePage(title: 'Flutter Demo Home Page'), // ? 首页
        'new_page': (context) => const NewRoute() // ? 新路由
      },
      // ! 路由生成钩子. onGenerateRoute回调: 当Navigator需要展示名为"/home"的路由时, 会调用onGenerateRoute函数, 返回HomeRoute类即可。当Navigator需要展示"/"或"/new_page"路由时, 会从路由表中查找对应的Route类并展示.
      // ? 常用于打开每一个路由页前判断用户登录状态.
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context)
                    .pushNamed('new_page', arguments: 'This is new route');
              },
            )
          ],
        ),
